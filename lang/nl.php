<?php
    return array(
        I_TITLE => 'Eed',
        I_SWEAR => 'Ik zweer,',
        I_INTRO => 'naar mijn beste *vermogen* en *inzicht*,
        
                    deze eed en deze overeenkomst
        ...
        I_OATH  => array(
            ...
            *kennis niet geheim moet worden gehouden* van hen die willen leren.)',
            ...
            'Ik zal mijn kennis niet gebruiken voor oneerlijk gewin(, financieel of anders. Ik zal niet beweren dat gebruik van
            technologie noodzakelijk is wanneer dat niet is, maar alleen voor het oplossen van *echte* problemen, vrij van opzettelijk onrecht.)',
            'Ik zal onthouden dat technologie altijd *verbetert*(, en zal nooit stoppen met leren, en het doel van mijn leven zal
            continue *zelfverbetering* zijn.)',
            ...
            niet misbruiken.)',
            'Ik zal onhouden dat, als een engineer, met mijn vermogen de *verplichting* komt( om te scheppen en het leven van mijn medemensen
            te verbeteren.)',
        ),
        I_CC => 'Creative Commons Licentie',
        I_EPILOGUE0 => 'Als ik deze eed niet breek,
        
                        mag het mij gegund zijn te genieten van mijn *leven* en *kunst*,
                        
                        *gerespecteerd* zolang ik leef
                        
                        en met *genegenheid* herdacht erna.',
        I_EPILOGUE1 => 'Laat mij de *beste tradities* van mijn roeping bewaken
        ...
        I_SHARE_FB  => 'Deel op Facebook',
        I_SHARE_TW  => 'Deel op Twitter'
    );
?>
