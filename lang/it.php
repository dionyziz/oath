<?php
    return array(
        I_TITLE => 'Giuramento',
        I_SWEAR => 'Prometto,',
        I_INTRO => 'di adempiere a seconda delle mie
                    
                    *abilità* e del mio *giudizio*
        ...
        I_OATH  => array(
            ...
            *la conoscenza non dev\'essere tenuta segreta* a coloro che desiderano imparare.)',
            ...
            'Ricorderò che esiste l\'*arte* dell\'ingegneria del software e della tecnologia (, e che esiste la bellezza nel codice. Non
            ...
            *creare* rendere la vita del mio prossimo migliore.)'
        ),
        I_CC => 'Creative Commons License',
        I_EPILOGUE0 => 'Se non violerò questo patto,
        
                        che mi sia concesso di godermi la *vita* e l\'*arte*,
                        
                        in modo *rispettoso*, e di essere 
                        
                        ricordato con *affetto*.',
        I_EPILOGUE1 => 'Che io possa agire per preservare le *migliori tradizioni* della mie vocazioni
        
                        e che io possa sperimentare a lungo la gioia dell\'*innovazione*.
                        
                        Che io possa sperimentare la *gioia* di offrire alla mia arte
                        
                        nuovi elementi per il *progresso* della stessa.',
        I_TAKE      => 'Prendi il giuramento',
        I_SHARE_FB  => 'Condividi su Facebook',
        I_SHARE_TW  => 'Condividi su Twitter'
    );
?>
